...
export interface MazeParts {
  group: THREE.Group; goal: THREE.Mesh; floorMat: THREE.MeshStandardMaterial; gridMat: THREE.LineBasicMaterial;
  width: number; height: number;
}

export function buildMazeGroup(maze: Maze, { cell, wallT, wallH, floorHex, gridHex }: MazeMeshOptions): MazeParts {
...
export function placeGoalMesh(mesh: THREE.Mesh, goal: GoalRect, cell: number, wallT: number): void {
