...
export const col = (hex: THREE.ColorRepresentation) => new THREE.Color(hex);
export const std = (hex: THREE.ColorRepresentation, opts: THREE.MeshStandardMaterialParameters = {}) => new THREE.MeshStandardMaterial({ color: col(hex), roughness: 0.6, metalness: 0, ...opts });
