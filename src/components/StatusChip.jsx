...
import { formatTime } from '../sim/SimController.js';

const NAMES = { idle: 'Not running', running: 'Running', paused: 'Paused', fault: 'Stopped by a fault', solved: 'Solved', error: 'Build failed' };
