...
const MAZE_TYPES = [['backtracker', 'Long corridors'], ['prim', 'Many branches'], ['braid', 'With loops'], ['arena', 'Open arena']];
const VIEWS = [['orbit', 'Orbit', 'Orbit around the maze (1)'], ['top', 'Top', 'Top-down plan (2)'], ['follow', 'Follow', 'Chase camera (3)'], ['pov', 'Robot', 'From the front sonar (4)']];
const SPEEDS = [0.25, 0.5, 1, 2, 4, 8];
const REPO_URL = import.meta.env.VITE_REPO_URL;

export default function TopBar({ panelOpen, onTogglePanel }) {
  ...
  return (
    <header className="bar">
      ...
      <div className="grp" aria-label="Maze">
        ...
        <select id="mazeType" className="sel" value={mz.type} onChange={e => sim.setMazeCfg({ type: e.target.value })} title="Maze type">
