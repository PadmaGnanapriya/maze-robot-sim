...
import type { LineEnd } from '../sim/settings.js';
  ...
  return (
    <>
      ...
      <div className="sin">
        ...
        <select className="sel" value={ui.lineEnd} onChange={e => sim.setUi({ lineEnd: e.target.value as LineEnd })} title="Line ending">
